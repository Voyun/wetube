...
app.set("views", _path["default"].join(__dirname, "views")); //app.use("/uploads", express.static("uploads"));
...
app.use(_middlewares.localsMiddleware); // 위치 파악 중요

app.use(_routes["default"].home, _globalRouter["default"]); // join login search home 이런것을 다룰 url
